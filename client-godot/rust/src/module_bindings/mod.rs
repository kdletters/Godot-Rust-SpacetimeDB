...
// This was generated using spacetimedb cli version 2.0.2 (commit e8a2d33155a41306d72d8688abacc5f12fcae09d).
...
impl __sdk::Reducer for Reducer {
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::Debug => __sats::bsatn::to_vec(&debug_reducer::DebugArgs {}),
            Reducer::EnterGame { name } => {
                __sats::bsatn::to_vec(&enter_game_reducer::EnterGameArgs { name: name.clone() })
            }
            Reducer::UpdatePlayerInput { direction } => {
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    const ALL_TABLE_NAMES: &'static [&'static str] =
        &["circle", "config", "entity", "food", "player"];
}
