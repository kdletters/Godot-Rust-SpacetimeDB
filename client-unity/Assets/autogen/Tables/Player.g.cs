...
namespace SpacetimeDB.Types
{
    ...
    public sealed class PlayerCols
    {
        ...
        public global::SpacetimeDB.Col<Player, uint> PlayerId { get; }
        ...
        public PlayerCols(string tableName)
        {
            ...
            PlayerId = new global::SpacetimeDB.Col<Player, uint>(tableName, "player_id");
    ...
    public sealed class PlayerIxCols
    {
        ...
        public global::SpacetimeDB.IxCol<Player, uint> PlayerId { get; }

        public PlayerIxCols(string tableName)
        {
            Identity = new global::SpacetimeDB.IxCol<Player, SpacetimeDB.Identity>(tableName, "identity");
            PlayerId = new global::SpacetimeDB.IxCol<Player, uint>(tableName, "player_id");
        }
    }
}
