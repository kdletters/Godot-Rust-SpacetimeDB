...
namespace SpacetimeDB.Types
{
    ...
    {
        public global::SpacetimeDB.Col<Entity, uint> EntityId { get; }
        public global::SpacetimeDB.Col<Entity, DbVector2> Position { get; }
        public global::SpacetimeDB.Col<Entity, uint> Mass { get; }

        public EntityCols(string tableName)
        {
            EntityId = new global::SpacetimeDB.Col<Entity, uint>(tableName, "entity_id");
            Position = new global::SpacetimeDB.Col<Entity, DbVector2>(tableName, "position");
            Mass = new global::SpacetimeDB.Col<Entity, uint>(tableName, "mass");
        }
    }

    public sealed class EntityIxCols
    {
        public global::SpacetimeDB.IxCol<Entity, uint> EntityId { get; }

        public EntityIxCols(string tableName)
        {
            EntityId = new global::SpacetimeDB.IxCol<Entity, uint>(tableName, "entity_id");
        }
    }
}
