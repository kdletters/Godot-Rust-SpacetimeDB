...
namespace SpacetimeDB.Types
{
    ...
    {
        public global::SpacetimeDB.Col<Food, uint> EntityId { get; }

        public FoodCols(string tableName)
        {
            EntityId = new global::SpacetimeDB.Col<Food, uint>(tableName, "entity_id");
        }
    }

    public sealed class FoodIxCols
    {
        public global::SpacetimeDB.IxCol<Food, uint> EntityId { get; }

        public FoodIxCols(string tableName)
        {
            EntityId = new global::SpacetimeDB.IxCol<Food, uint>(tableName, "entity_id");
        }
    }
}
